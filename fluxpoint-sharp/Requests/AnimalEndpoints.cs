...
public class AnimalEndpoints
{
    ...
    public Task<FileResponse> GetCatAsync()
        => Client.SendRequest<FileResponse>(HttpType.Get, "/sfw/img/cat");

    public Task<FileResponse> GetDogAsync()
        => Client.SendRequest<FileResponse>(HttpType.Get, "/sfw/img/dog");

    public Task<FileResponse> GetDuckAsync()
        => Client.SendRequest<FileResponse>(HttpType.Get, "/sfw/img/duck");

    public Task<FileResponse> GetLizardAsync()
        => Client.SendRequest<FileResponse>(HttpType.Get, "/sfw/img/lizard");
