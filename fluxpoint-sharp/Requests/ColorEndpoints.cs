...
namespace fluxpoint_sharp
{
    public class ColorEndpoints
    {
        ...
        public Task<ColorResponse> GetRandomColorAsync()
            => Client.SendRequest<ColorResponse>(HttpType.Get, ApiType.Fluxpoint, "/color/random");
        ...
        public Task<ColorResponse> GetNameColorAsync(string colorName)
        {
            ...
            return Client.SendRequest<ColorResponse>(HttpType.Get, ApiType.Fluxpoint, "/color/info?name=" + colorName);
        }
        ...
        public Task<ColorResponse> GetHexColorAsync(string hexColor)
        {
            ...
            return Client.SendRequest<ColorResponse>(HttpType.Get, ApiType.Fluxpoint, "/color/info?hex=" + hexColor);
        }
        ...
        public Task<ColorResponse> GetRGBColorAsync(int r, int g, int b)
        {
            ...
            return Client.SendRequest<ColorResponse>(HttpType.Get, ApiType.Fluxpoint, $"/color/info?rgb={r},{g},{b}");
        }
    }
}
